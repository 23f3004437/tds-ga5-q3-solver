...
# ===========================================================================
SECRET = os.environ.get("Q3_SECRET", "/home/agent/service-account.json")
WRITE_ROOT = os.environ.get("Q3_WRITE_ROOT", "/home/agent/workspace/build").rstrip("/")
ALLOWED_HOSTS = {
    h.strip().lower()
    for h in os.environ.get("Q3_ALLOWED_HOSTS", "api.github.com,huggingface.co").split(",")
    if h.strip()
}
